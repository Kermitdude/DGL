	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body" style="text-align: center">
				...
				<button id="modal-adduser-confirm" type="button" class="btn btn-success" data-dismiss="modal">Confirm</button>
...
<div id="modal-deleteuser" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
		
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title"><i class="fa fa-user-plus"></i> Delete user?</h4>
			</div>
			
			<div class="modal-body" style="text-align: center">
			
				<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>	
				<button id="modal-deleteuser-confirm" type="button" class="btn btn-success">Confirm</button>
