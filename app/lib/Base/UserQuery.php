 ...
 *
 * @method     \DigitalGaming\UserRoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    /**
     * Initializes internal state of \DigitalGaming\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'dgl', $modelName = '\\DigitalGaming\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT name, password, email, created_at, updated_at, id FROM user WHERE id = :p0';
        try {
    ...
    /**
     * Copy the data of the objects satisfying the query into ChildUserArchive archive objects.
