...
use \Exception;
use \PDO;
use DigitalGaming\Permission as ChildPermission;
use DigitalGaming\PermissionQuery as ChildPermissionQuery;
use DigitalGaming\Role as ChildRole;
use DigitalGaming\RolePermission as ChildRolePermission;
use DigitalGaming\RolePermissionQuery as ChildRolePermissionQuery;
use DigitalGaming\RoleQuery as ChildRoleQuery;
use DigitalGaming\User as ChildUser;
use DigitalGaming\UserQuery as ChildUserQuery;
use DigitalGaming\UserRole as ChildUserRole;
use DigitalGaming\UserRoleQuery as ChildUserRoleQuery;
...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DigitalGaming\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of DigitalGaming\Base\Role object.
     */
     ...
     * @return $this|\DigitalGaming\Role The current object (for fluent API support)
     */
    ...
    public function setAnnotation($v)
    {
        ...
        if ($this->annotation !== $v) {
            $this->annotation = $v;
            $this->modifiedColumns[RoleTableMap::COL_ANNOTATION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RoleTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RoleTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RoleTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RoleTableMap::translateFieldName('Annotation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->annotation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RoleTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RoleTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\DigitalGaming\\Role'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(RoleTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(RoleTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(RoleTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->usersScheduledForDeletion !== null) {
                if (!$this->usersScheduledForDeletion->isEmpty()) {
                    ...
                    \DigitalGaming\UserRoleQuery::create()
            ...
            if ($this->permissionsScheduledForDeletion !== null) {
                if (!$this->permissionsScheduledForDeletion->isEmpty()) {
                    ...
                    \DigitalGaming\RolePermissionQuery::create()
                        ->filterByPrimaryKeys($pks)
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RoleTableMap::COL_ANNOTATION)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collRolePermissions) {
                ...
                $result[$key] = $this->collRolePermissions->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DigitalGaming\Role
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DigitalGaming\Role The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RoleTableMap::COL_ANNOTATION)) {
            $criteria->add(RoleTableMap::COL_ANNOTATION, $this->annotation);
        }
        if ($this->isColumnModified(RoleTableMap::COL_CREATED_AT)) {
            $criteria->add(RoleTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(RoleTableMap::COL_UPDATED_AT)) {
            $criteria->add(RoleTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(RoleTableMap::COL_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DigitalGaming\Role (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DigitalGaming\Role Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUserRoles($overrideExisting = true)
    {
        ...
        $this->collUserRoles->setModel('\DigitalGaming\UserRole');
    }
    ...
    public function initRolePermissions($overrideExisting = true)
    {
        ...
        $this->collRolePermissions->setModel('\DigitalGaming\RolePermission');
    }
    ...
    public function initUsers()
    {
        ...
        $this->collUsers->setModel('\DigitalGaming\User');
    }
    ...
    public function initPermissions()
    {
        ...
        $this->collPermissions->setModel('\DigitalGaming\Permission');
    }
