...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DigitalGaming\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of DigitalGaming\Base\UserRole object.
     */
     ...
     * @return $this|\DigitalGaming\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\DigitalGaming\\UserRole'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DigitalGaming\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DigitalGaming\UserRole The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DigitalGaming\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DigitalGaming\UserRole Clone of current object.
     * @throws PropelException
     */
