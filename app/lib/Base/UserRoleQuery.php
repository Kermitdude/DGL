...
use DigitalGaming\Map\UserRoleTableMap;
 ...
 *
 * @method     \DigitalGaming\UserQuery|\DigitalGaming\RoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DigitalGaming\Base\UserRoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'dgl', $modelName = '\\DigitalGaming\\UserRole', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \DigitalGaming\User object
     *
     * @param \DigitalGaming\User|ObjectCollection $user The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($user instanceof \DigitalGaming\User) {
            return $this
            ...
            throw new PropelException('filterByUser() only accepts arguments of type \DigitalGaming\User or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \DigitalGaming\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\DigitalGaming\UserQuery');
    }
