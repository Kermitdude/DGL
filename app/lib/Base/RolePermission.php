...
/**
 * Base class that represents a row from the 'role_permission' table.
 *
 *
 *
...
abstract class RolePermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DigitalGaming\\Map\\RolePermissionTableMap';
    ...
    /**
     * Initializes internal state of DigitalGaming\Base\RolePermission object.
     */
     ...
     * @return $this|\DigitalGaming\RolePermission The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\DigitalGaming\\RolePermission'), 0, $e);
        }
    }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['RolePermission'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RolePermission'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DigitalGaming\RolePermission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DigitalGaming\RolePermission The current object, for fluid interface
     */
    ...
    {
        $criteria = ChildRolePermissionQuery::create();
        $criteria->add(RolePermissionTableMap::COL_ROLE_ID, $this->role_id);
        $criteria->add(RolePermissionTableMap::COL_PERMISSION_ID, $this->permission_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DigitalGaming\RolePermission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DigitalGaming\RolePermission Clone of current object.
     * @throws PropelException
     */
