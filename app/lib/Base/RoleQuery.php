...
use \Exception;
use \PDO;
use DigitalGaming\Role as ChildRole;
use DigitalGaming\RoleQuery as ChildRoleQuery;
use DigitalGaming\Map\RoleTableMap;
 ...
 * @method     ChildRoleQuery orderByAnnotation($order = Criteria::ASC) Order by the annotation column
 * @method     ChildRoleQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildRoleQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 ...
 * @method     ChildRoleQuery groupByAnnotation() Group by the annotation column
 * @method     ChildRoleQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildRoleQuery groupByUpdatedAt() Group by the updated_at column
 ...
 *
 * @method     \DigitalGaming\UserRoleQuery|\DigitalGaming\RolePermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildRole findOneByAnnotation(string $annotation) Return the first ChildRole filtered by the annotation column
 * @method     ChildRole findOneByCreatedAt(string $created_at) Return the first ChildRole filtered by the created_at column
 * @method     ChildRole findOneByUpdatedAt(string $updated_at) Return the first ChildRole filtered by the updated_at column
 ...
 * @method     ChildRole requireOneByAnnotation(string $annotation) Return the first ChildRole filtered by the annotation column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRole requireOneByCreatedAt(string $created_at) Return the first ChildRole filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRole requireOneByUpdatedAt(string $updated_at) Return the first ChildRole filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildRole[]|ObjectCollection findByAnnotation(string $annotation) Return ChildRole objects filtered by the annotation column
 * @method     ChildRole[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildRole objects filtered by the created_at column
 * @method     ChildRole[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildRole objects filtered by the updated_at column
...
abstract class RoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DigitalGaming\Base\RoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'dgl', $modelName = '\\DigitalGaming\\Role', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT name, annotation, created_at, updated_at, id FROM role WHERE id = :p0';
        try {
    ...
    public function filterByAnnotation($annotation = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RoleTableMap::COL_ANNOTATION, $annotation, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(RoleTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(RoleTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RoleTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(RoleTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(RoleTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RoleTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    /**
     * Filter the query by a related \DigitalGaming\UserRole object
     *
     * @param \DigitalGaming\UserRole|ObjectCollection $userRole the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($userRole instanceof \DigitalGaming\UserRole) {
            return $this
            ...
            throw new PropelException('filterByUserRole() only accepts arguments of type \DigitalGaming\UserRole or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \DigitalGaming\UserRoleQuery A secondary query class using the current class as primary query
     */
    public function useUserRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserRole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRole', '\DigitalGaming\UserRoleQuery');
    }

    /**
     * Filter the query by a related \DigitalGaming\RolePermission object
     *
     * @param \DigitalGaming\RolePermission|ObjectCollection $rolePermission the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildRoleQuery The current query, for fluid interface
     */
    ...
    {
        if ($rolePermission instanceof \DigitalGaming\RolePermission) {
            return $this
            ...
            throw new PropelException('filterByRolePermission() only accepts arguments of type \DigitalGaming\RolePermission or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \DigitalGaming\RolePermissionQuery A secondary query class using the current class as primary query
     */
    public function useRolePermissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'RolePermission', '\DigitalGaming\RolePermissionQuery');
    }
    ...
    {
        return $this->addUsingAlias(RoleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RoleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RoleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RoleTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(RoleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RoleTableMap::COL_CREATED_AT);
    }
