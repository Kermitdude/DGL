...
use DigitalGaming\Map\UserTableMap;
...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DigitalGaming\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of DigitalGaming\Base\User object.
     */
     ...
     * @return $this|\DigitalGaming\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\DigitalGaming\\User'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DigitalGaming\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DigitalGaming\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DigitalGaming\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DigitalGaming\User Clone of current object.
     * @throws PropelException
     */
     ...
     * @param ConnectionInterface $con Optional connection object
     *
     * @return     ChildUserArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildUserArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildUserArchive The archive object based on this object
     */
     ...
     *
     * @param      ChildUserArchive $archive An archived object based on the same class
