 ...
 * @method     ChildPermissionQuery orderByAnnotation($order = Criteria::ASC) Order by the annotation column
 ...
 * @method     ChildPermissionQuery groupByAnnotation() Group by the annotation column
 ...
 *
 * @method     \DigitalGaming\RolePermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPermission findOneByAnnotation(string $annotation) Return the first ChildPermission filtered by the annotation column
 ...
 * @method     ChildPermission requireOneByAnnotation(string $annotation) Return the first ChildPermission filtered by the annotation column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPermission[]|ObjectCollection findByAnnotation(string $annotation) Return ChildPermission objects filtered by the annotation column
...
abstract class PermissionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DigitalGaming\Base\PermissionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'dgl', $modelName = '\\DigitalGaming\\Permission', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT name, annotation, id FROM permission WHERE id = :p0';
        try {
    ...
    public function filterByAnnotation($annotation = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_ANNOTATION, $annotation, $comparison);
    }
