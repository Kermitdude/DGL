 ...
 * @method     ChildSettingQuery orderByValue($order = Criteria::ASC) Order by the value column
 ...
 * @method     ChildSettingQuery groupByValue() Group by the value column
 ...
 * @method     ChildSetting findOneByValue(string $value) Return the first ChildSetting filtered by the value column
 ...
 * @method     ChildSetting requireOneByValue(string $value) Return the first ChildSetting filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSetting[]|ObjectCollection findByValue(string $value) Return ChildSetting objects filtered by the value column
...
abstract class SettingQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DigitalGaming\Base\SettingQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'dgl', $modelName = '\\DigitalGaming\\Setting', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SettingTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT name, value, created_at, updated_at, id FROM setting WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SettingTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_VALUE, $value, $comparison);
    }
