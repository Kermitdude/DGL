...
use DigitalGaming\Permission;
use DigitalGaming\PermissionQuery;
...
class PermissionTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\Permission';
     ...
     */
    const COL_ANNOTATION = 'permission.annotation';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Annotation', 'Id', ),
        self::TYPE_CAMELNAME     => array('name', 'annotation', 'id', ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_NAME, PermissionTableMap::COL_ANNOTATION, PermissionTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('name', 'annotation', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Annotation' => 1, 'Id' => 2, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'annotation' => 1, 'id' => 2, ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_NAME => 0, PermissionTableMap::COL_ANNOTATION => 1, PermissionTableMap::COL_ID => 2, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'annotation' => 1, 'id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\Permission');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addColumn('name', 'Name', 'VARCHAR', true, 64, null);
        $this->addColumn('annotation', 'Annotation', 'VARCHAR', true, 250, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PermissionTableMap::COL_ANNOTATION);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\Permission) { // it's a model object
