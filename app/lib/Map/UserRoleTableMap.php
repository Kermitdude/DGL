...
use DigitalGaming\UserRole;
use DigitalGaming\UserRoleQuery;
...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\UserRole';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\UserRole');
        $this->setPackage('');
    ...
    {
        $this->addRelation('User', '\\DigitalGaming\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \DigitalGaming\UserRole $obj A \DigitalGaming\UserRole object.
     ...
     *
     * @param mixed $value A \DigitalGaming\UserRole object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \DigitalGaming\UserRole) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \DigitalGaming\UserRole object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\UserRole) { // it's a model object
