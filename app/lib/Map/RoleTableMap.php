...
use DigitalGaming\Role;
use DigitalGaming\RoleQuery;
...
class RoleTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\Role';
     ...
     */
    const COL_ANNOTATION = 'role.annotation';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'role.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'role.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Annotation', 'CreatedAt', 'UpdatedAt', 'Id', ),
        self::TYPE_CAMELNAME     => array('name', 'annotation', 'createdAt', 'updatedAt', 'id', ),
        self::TYPE_COLNAME       => array(RoleTableMap::COL_NAME, RoleTableMap::COL_ANNOTATION, RoleTableMap::COL_CREATED_AT, RoleTableMap::COL_UPDATED_AT, RoleTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('name', 'annotation', 'created_at', 'updated_at', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Annotation' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'Id' => 4, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'annotation' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'id' => 4, ),
        self::TYPE_COLNAME       => array(RoleTableMap::COL_NAME => 0, RoleTableMap::COL_ANNOTATION => 1, RoleTableMap::COL_CREATED_AT => 2, RoleTableMap::COL_UPDATED_AT => 3, RoleTableMap::COL_ID => 4, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'annotation' => 1, 'created_at' => 2, 'updated_at' => 3, 'id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\Role');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addColumn('name', 'Name', 'VARCHAR', true, 32, null);
        $this->addColumn('annotation', 'Annotation', 'VARCHAR', false, 250, null);
    ...
    {
        $this->addRelation('UserRole', '\\DigitalGaming\\UserRole', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':id',
        ...
        $this->addRelation('RolePermission', '\\DigitalGaming\\RolePermission', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RoleTableMap::COL_ANNOTATION);
            $criteria->addSelectColumn(RoleTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(RoleTableMap::COL_UPDATED_AT);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\Role) { // it's a model object
