...
use DigitalGaming\User;
use DigitalGaming\UserQuery;
...
class UserTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\User';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Password', 'Email', 'CreatedAt', 'UpdatedAt', 'Id', ),
        self::TYPE_CAMELNAME     => array('name', 'password', 'email', 'createdAt', 'updatedAt', 'id', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_NAME, UserTableMap::COL_PASSWORD, UserTableMap::COL_EMAIL, UserTableMap::COL_CREATED_AT, UserTableMap::COL_UPDATED_AT, UserTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('name', 'password', 'email', 'created_at', 'updated_at', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Password' => 1, 'Email' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Id' => 5, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'password' => 1, 'email' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'id' => 5, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_NAME => 0, UserTableMap::COL_PASSWORD => 1, UserTableMap::COL_EMAIL => 2, UserTableMap::COL_CREATED_AT => 3, UserTableMap::COL_UPDATED_AT => 4, UserTableMap::COL_ID => 5, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'password' => 1, 'email' => 2, 'created_at' => 3, 'updated_at' => 4, 'id' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\User');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\User) { // it's a model object
