...
use DigitalGaming\Setting;
use DigitalGaming\SettingQuery;
...
class SettingTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\Setting';
     ...
     */
    const COL_NAME = 'setting.name';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'setting.value';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'setting.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'setting.updated_at';

    /**
     * the column name for the id field
     */
    const COL_ID = 'setting.id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Value', 'CreatedAt', 'UpdatedAt', 'Id', ),
        self::TYPE_CAMELNAME     => array('name', 'value', 'createdAt', 'updatedAt', 'id', ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_NAME, SettingTableMap::COL_VALUE, SettingTableMap::COL_CREATED_AT, SettingTableMap::COL_UPDATED_AT, SettingTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('name', 'value', 'created_at', 'updated_at', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Value' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'Id' => 4, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'value' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'id' => 4, ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_NAME => 0, SettingTableMap::COL_VALUE => 1, SettingTableMap::COL_CREATED_AT => 2, SettingTableMap::COL_UPDATED_AT => 3, SettingTableMap::COL_ID => 4, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'value' => 1, 'created_at' => 2, 'updated_at' => 3, 'id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\Setting');
        $this->setPackage('');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingTableMap::COL_VALUE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\Setting) { // it's a model object
