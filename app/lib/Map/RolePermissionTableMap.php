...
use DigitalGaming\RolePermission;
use DigitalGaming\RolePermissionQuery;
...
class RolePermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.RolePermissionTableMap';
     ...
     */
    const OM_CLASS = '\\DigitalGaming\\RolePermission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'RolePermission';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_CAMELNAME     => array('roleId', 'permissionId', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_CAMELNAME     => array('roleId' => 0, 'permissionId' => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DigitalGaming\\RolePermission');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Role', '\\DigitalGaming\\Role', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':id',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \DigitalGaming\RolePermission $obj A \DigitalGaming\RolePermission object.
     ...
     *
     * @param mixed $value A \DigitalGaming\RolePermission object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \DigitalGaming\RolePermission) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \DigitalGaming\RolePermission object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DigitalGaming\RolePermission) { // it's a model object
